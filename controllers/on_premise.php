...
/**
 * System applications on premise controller.
 *
 * @category   apps
...
class On_Premise extends ClearOS_Controller
{
    /**
...
*/
        ...
        $this->page->view_form('system_services/on_premise', $data, lang('system_services_on_premise_services'));
    }
}
